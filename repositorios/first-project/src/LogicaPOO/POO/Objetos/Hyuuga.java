...
public class Hyuuga {
    ...
    String nameHyuuga1 = "Nejiy";
    int ageHyuuga1 = 20;
    String missionHyuuga1 = "Protect the princess Hinata.";
    String missionStatus1 = "Loading...";
    char missionLevelHyuuga1 = 'B';

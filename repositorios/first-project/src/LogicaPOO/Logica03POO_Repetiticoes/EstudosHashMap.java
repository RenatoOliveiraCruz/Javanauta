...
public class EstudosHashMap {
    ...
    //  Iterando através da chave (.keySet()) = "Coleta nome do aluno e sua nota posteriormente":
        for (String nome : notasAlunos.keySet()) {
            double nota = notasAlunos.get(nome);
            System.out.println(nome + " : " + nota);
        }

    //  Iterando individualmente cada valor dentro da chave (.entrySet()):
    ...
    //  Contando elemento do HashMap:
        int tamanhoHash = notasAlunos.size();

    //  Removendo elemento do HashMap:
